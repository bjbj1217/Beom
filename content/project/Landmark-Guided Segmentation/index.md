...
<div style="text-align: center;">
    <div style="display: flex; justify-content: center; gap: 40px; flex-wrap: wrap;">
        <figure style="width: 45%; margin: 0;">
            <img src="CT_measure.png" alt="Aortic measurements" style="width: 100%; height: 300px; object-fit: contain; background: #f0f0f0;" />
        ...
        <figure style="width: 45%; margin: 0;">
            <img src="CFD.png" alt="CFD" style="width: 100%;  height: 300px; object-fit: contain; background: #f0f0f0;" />
            <figcaption style="margin-top: 4px; font-size: 0.85em; color: #999;">
